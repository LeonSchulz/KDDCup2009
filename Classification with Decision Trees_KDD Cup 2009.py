...
for i in range(10):
    ...
    AUC_chu += roc_auc(chu_val,LGBM_chu_pred_proba[1])
    AUC_app += roc_auc(app_val,LGBM_app_pred_proba[1])
    AUC_up += roc_auc(up_val,LGBM_up_pred_proba[1])
...
AUC_average = (AUC_chu + AUC_app + AUC_up)/3
